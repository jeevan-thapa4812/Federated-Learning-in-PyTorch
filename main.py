...
from src import check_args, load_dataset, load_model, Range, set_logger, set_seed, TensorBoardRunner
...
if __name__ == "__main__":
    ...
    parser.add_argument('--K', help='number of total clients participating in federated training', type=int,
                        default=100)
